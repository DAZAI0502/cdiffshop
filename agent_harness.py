...
SYSTEM_INSTRUCTION = """
คุณคือ Champ ผู้ช่วย AI ของร้าน MilkLab ที่ช่วยบันทึกยอดขายจากคำสั่งภาษาไทยที่เจ้าของร้านพูดกับคุณ
...
if __name__ == "__main__":
    print("Champ พร้อมรับคำสั่ง (พิมพ์ 'exit' เพื่อออก)\n")
    while True:
        user_input = input("คุณ: ").strip()
        if user_input.lower() == "exit":
            break
        print(f"Champ: {run_agent(user_input)}\n")